...
<template>
  <div class="container mt-8">
    ...
    <p class="text-white md:text-[16px] text-[12px] font-medium">
      ...
      <ul class="text-white md:text-[16px] text-[12px] font-medium flex flex-col gap-[12px]">
        ...
        <p class="text-white md:text-[16px] text-[12px] font-semibold">
          2. Information We Collect When using the Darna app, we may collect the following types of information:
        </p>
        <li class="text-white md:text-[16px] text-[12px] font-medium">
          * Personal Information: Name, email address, phone number, and profile details when you sign up.
        </li>
  ...
  * To provide and personalize your experience in the app.
        ...
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  * To allow you to browse, list, and manage properties.
        </li>
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  * To facilitate auction participation and bidding.
        </li>
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  * To improve our services and app performance.
        </li>
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  ...
  * To comply with legal obligations and prevent fraud.
        ...
        4. How We Share Your Information We do not sell your personal data. However, we may share your information with:
        </p>
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  * Other Users: Property listings and auction details are visible to other users.
        </li>
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  * Service Providers: Third-party partners who assist in app functionality and payment processing.
        </li>
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  * Legal Authorities: When required by law or to protect our rights.
        ...
        5. Data Security We implement security measures to protect your data from unauthorized access, misuse, or loss.
        </p>
        <p class="text-white md:text-[16px] text-[12px] font-semibold">

        6. Your Rights and Choices You have the right to:
        </p>
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  ...
  * Manage notification preferences.
        ...
        <li class="text-white md:text-[16px] text-[12px] font-medium">
  * Control location sharing via device settings.
        </li>
        <p class="text-white md:text-[16px] text-[12px] font-semibold">
  7. Changes to This Policy We may update this Privacy Policy from time to time. We will notify you of any significant changes by updating the policy within the app.
